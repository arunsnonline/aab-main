...
<body>
	...
	<form:form method="post">
		<display:table name="stateList" defaultsort="1"
			...
			<display:column property="stateName" title="NAME" />
			<display:column href="state/edit.htm" paramId="id" paramProperty="id">Edit</display:column>
		</display:table>
	</form:form>
	</div>
</body>
